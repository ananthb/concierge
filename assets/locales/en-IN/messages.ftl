...
demo-chat-envelope-note = The shaded sections are Concierge's safety wrapper — added to every prompt and not editable. Only the middle section comes from the persona.
